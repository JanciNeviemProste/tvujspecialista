...
export class SubscriptionsController {
  ...
  async createEducationCheckout(@Request() req) {
  ...
  @ApiResponse({ status: 200, description: 'Checkout session created' })
  async createMarketplaceCheckout(@Request() req) {
  ...
  @ApiResponse({ status: 200, description: 'Checkout session created' })
  async createPremiumCheckout(@Request() req) {
  ...
  async upgrade(
    ...
    return this.subscriptionsService.upgradeSubscription(req.user.userId, dto.newType);
  }
  ...
  async downgrade(
    ...
    return this.subscriptionsService.downgradeSubscription(req.user.userId, dto.newType);
  }
