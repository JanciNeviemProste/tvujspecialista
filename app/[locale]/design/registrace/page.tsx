...
const VARIANTS = [
  ...
  },
  {
    ...
    description:
      'Editorial indigo/amber s Instrument Serif italickými akcentmi. Social proof feed s avatarmi existujúcich členov, password strength indicator, inline validation, trust stack pri CTA. Pridaj sa k elitnému kruhu pocit.',
  ...
  },
  {
    ...
    description:
      'Geist + mono, terminal-style form flow, real-time tsc-like validation console, KPI dashboard preview, "Deploy your profile in 60s" tagline. Ako Linear alebo Vercel signup.',
  ...
  },
  {
    ...
    description:
      'Split-screen s portrait fotkou, Fraunces serif dropcap, form ako klasická pracovná prihláška s ladnými border underlines. Slow, deliberate, prestige.',
  ...
  },
  {
    ...
    description:
      'Oversized display "ZARÁBAŤ. UŽ.", chunky color blocks, bullet benefits v huge brutalist kartách, "LIMITED SPOTS" marquee. Loud, direct, urgency.',
  ...
  },
  {
    ...
    description:
      'Newspaper masthead "Vol. I · Apply", article-style benefits s dropcaps, form ako application letter s serif fields, "Prihláška" pečiatka. Rust accent na focus.',
...
export default function DesignRegistraceIndexPage() {
  return (
    <div
      ...
      <div className="container mx-auto px-6 py-20 sm:py-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg text-neutral-600 dark:text-neutral-400">
            ...
            layout formulára a sociálny dôkaz. Klikni na ktorýkoľvek a pozri si ho v plnej veľkosti.
          </p>
        </div>
        ...
        <div className="mt-20 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {VARIANTS.map((variant) => (
            <Link
              key={variant.id}
              href={`/design/registrace/${variant.id}` as '/design/registrace/v1'}
