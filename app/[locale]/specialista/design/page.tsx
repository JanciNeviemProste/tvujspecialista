...
const VARIANTS = [
  ...
  },
  {
    ...
    description:
      'Editorial asymmetric hero, serif italic meno, sticky booking widget s response time guarantee, service menu s cenami, availability calendar, reviews s filtrom.',
  ...
  },
  {
    ...
    description:
      'Dense data-driven layout, metrics dashboard, terminal response time indicator, mono service tags, availability heatmap, reviews timeline.',
  ...
  },
  {
    ...
    description:
      'Full-bleed portrait hero, editorial name treatment, pull-quote bio, minimal booking CTA, pricing ako pricing list, reviews ako listy.',
  ...
  },
  {
    ...
    description:
      'Oversized meno, giant BOOK NOW button, chunky stat blocks, loud reviews s rating badges, inline calendar, video intro player.',
  ...
  },
  {
    ...
    description:
      'Newspaper feature story style, drop cap bio, classified-ad services, "Schedule an interview" CTA, reviews ako published quotes s bylines.',
...
export default function SpecialistaDesignIndexPage() {
  return (
    <div
      ...
      <div className="container mx-auto px-6 py-20 sm:py-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg text-neutral-600 dark:text-neutral-400">
            Šesť rôznych prístupov k prezentácii profilu špecialistu. Každý variant má iný booking flow, trust signals, a spôsob prezentácie bio a služieb.
          </p>
        </div>
        ...
        <div className="mt-20 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {VARIANTS.map((variant) => (
            <Link
              key={variant.id}
              href={`/specialista/design/${variant.id}` as '/specialista/design/v1'}
