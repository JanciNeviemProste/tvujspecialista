  ...
  return (
    <div className="text-center py-12">
      <div className="flex justify-center mb-4">
        <div className="w-16 h-16 rounded-full bg-gray-200 dark:bg-muted flex items-center justify-center">
  ...
  if (isLoading) {
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <div className="h-8 bg-gray-200 dark:bg-muted shimmer rounded w-48 mb-2" />
          <div className="h-4 bg-gray-200 dark:bg-muted shimmer rounded w-64" />
        </div>
          ...
          {[...Array(4)].map((_, i) => (
            <Card key={i} className="h-32">
              <CardContent className="p-6">
                <div className="h-full bg-gray-200 dark:bg-muted shimmer rounded" />
              </CardContent>
            </Card>
          ))}
        </div>
        ...
        <div className="mb-12">
          <div className="h-6 bg-gray-200 dark:bg-muted shimmer rounded w-40 mb-6" />
